...
class SaltContactsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        $this->publishes([
            __DIR__.'/../../config/salt-contacts.php' => config_path('salt-contacts.php'),
        ], 'contacts-config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-contacts');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-contacts');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/salt-contacts'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'salt-contacts');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/salt-contacts'),
        // ], 'views');
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/salt-contacts'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/salt-contacts.php', 'salt-contacts'
        // );
    }
}
