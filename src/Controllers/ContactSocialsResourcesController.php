...
/**
 * @OA\Info(
 *      title="Contact Socials Endpoint",
 *      version="1.0",
 *      @OA\Contact(
 *          name="Farid Hidayat",
 ...
 *  )
 */
class ContactSocialsResourcesController extends Controller
{
    protected $modelNamespace = 'SaltContacts';

    /**
     * @OA\Get(
     *      path="/api/v1/contact_socials",
     ...
     *      @OA\Response(
     *          response="200",
     *          description="List of Contact Socials"
     *      ),
